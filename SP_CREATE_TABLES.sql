...
/*THIS IS TEH AUDIT TABLE WHERE WE WILL CAPTURE ALL THE OPEARTION AND DETAILS FOR AUDITING*/
...
/* THIS IS THE FINAL AREA, WHERE WE WILL HAVE ALL CLEAN DATA */
...
CASE 
    ...
    WHEN REG.REGION_ID=1 OR REG.REGION_ID=4 THEN 'LATAM'
    WHEN CNT.COUNTRY_NAME IN ('Aregentina','Brazil','Mexico') THEN 'LATAM'
...
SELECT COUNT(*) INTO TABLE_COUNT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA=
'HRDB';
